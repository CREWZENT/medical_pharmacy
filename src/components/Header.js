        ...
        case 'main':          
          return (
            <div className={'header__wrapper cb_clear'}>
              ...
              <Button type="surgery" text="product" click={this._getHeaderItems} headerType="surgery" />
              <Button type="discount" text="discount" click={this._getHeaderItems} headerType="discount" />
            </div>
          );
        case 'surgery':
        case 'discount':
          return (
            <div className={'header__wrapper cb_clear br-b-n'}>
              <i onClick={(()=>{this._getHeaderItems('main')})} className={'ico'}><FontAwesomeIcon icon={faTimes} /></i> <h2>{type === 'surgery' ? 'Product Menu' : 'Sale'}</h2>
            </div>  
          );
        default:
          return (
